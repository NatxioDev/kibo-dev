...
export default function PrivacyPage() {
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-4 py-10 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
      ...
      <Section title="1. Datos que recopilamos">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            Transacciones (montos, moneda, fechas, descripciones), categorías y
            métodos de pago.
          </li>
          <li>Los comentarios o reportes que nos envíes desde la app.</li>
        </ul>
        <p>
          No accedemos a tus contactos, correos, archivos ni a ningún otro dato
      ...
      <Section title="3. Uso de datos de Google">
        <p>
          El uso que hace Kibo de la información recibida de las APIs de Google
          cumple con la{" "}
          <a
      ...
      <Section title="5. Cookies">
        <p>
          Usamos únicamente cookies necesarias para mantener tu sesión iniciada
          y recordar tu preferencia de tema. No usamos cookies de publicidad ni
      ...
      <Section title="7. Tus derechos">
        <p>
          ...
          para cualquier otra solicitud, contáctanos. También puedes revocar el
          acceso de Kibo a tu cuenta de Google desde{" "}
          <a
